...
const DefaultSlip = ({
  ...
  const handleSaveInstructions = () => {
    ...
    // Instructions are already saved in editableData through the onChange
  };
              ...
              {isEditingInstructions ? (
                ...
                <div className="editable-instructions">
                  ...
                  <div className="form-text mt-2">
                    Tip: Press Enter for new lines. Each line will be treated as
                    a separate point.
                  </div>
                </div>
              ) : (
                ...
                <div className="static-instructions">
                  <p className="instructionItem">
                    {editableData.instructionsText ? (
                      ...
                      <>
                        1. You are advised to report at exam centre thirty (30)
                        minutes before the scheduled paper time.
                        <br />
                        2. You are advised to bring this ROLL NO SLIP along with
                        your Original National ID Card / Passport or B-Form or
                        Matric Certificate (less than 18 years age) containing
                        your photograph (mandatory). Candidates failing to
                        produce ROLL NO SLIP and Original CNIC would not be
                        allowed to enter the examination hall.
                        <br />
                        3. If your CNIC/B Form is lost, please bring a copy of
                        FIR, Newspaper cutting and Original NADRA token showing
                        that you have applied for the same.
                        <br />
                        4. Please don't bring any of Gadgets with you.
                        Candidates shall be searched for
                        cellphones/smart/watch/electronic devices and if found,
                        it will be confiscated and UFM case shall be registered
                        accordingly.
                        <br />
                        5. No candidate will be allowed to enter the examination
                        hall after 15 minutes of the start of paper.
                        <br />
                        6. Any student who fails to fill the paper code or Roll
                        No on MCQ response sheet will be considered absent.
                        <br />
                        7. This Roll No is being issued provisionally and shall
                        be confirmed subject to verification.
                      </>
                    )}
                  </p>
                </div>
